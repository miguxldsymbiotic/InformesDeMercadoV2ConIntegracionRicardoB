...
def server(input, output, session):
    ...
    def _prepare_report_content(engine, p):
        ...
        data_ctx["sections"].append({
            ...
            "table": f"""
#v(1em)
== Detalle de Oferta Académica (Top 40)
{_get_oferta_table_typst()}
...
"""
        ...
        data_ctx["sections"].append({
            ...
            "table": f"""
#v(1em)
== Movilidad Laboral: Intercambio de Graduados
{_get_ole_mobility_table_typst()}
"""
        })
        ...
        data_ctx["sections"].append({
            ...
            "table": f"""
#v(1em)
== Detalle de Resultados por Componente
{_get_saber_table_typst()}
"""
        })
